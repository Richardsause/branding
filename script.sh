...
## DNF related stuff
sudo dnf up -y
notify-send "updated the system"
...
notify-send "all the apps installed, and thermald has been enabled"
...
notify-send "default cursor added and applied for the current user"
...
notify-send "added trashbin file to the desktop"
